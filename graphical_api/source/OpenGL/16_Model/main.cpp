...
int main()
{
	...
	Shader shader("F:/github/MO1/MobileOpenGL/bin/shader/model.vs", "F:/github/MO1/MobileOpenGL/bin/shader/model.fs");
	Model model("F:/github/MO1/MobileOpenGL/bin/asset/model/nanosuit.obj");
