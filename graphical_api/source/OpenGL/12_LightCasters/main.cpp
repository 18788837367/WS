...
int main()
{
	...
	Shader lightCubeShader("F:/github/MO1/MobileOpenGL/bin/shader/LightingMaps_LightCube.vs", "F:/github/MO1/MobileOpenGL/bin/shader/LightingMaps_LightCube.fs");
	Shader materialsShader("F:/github/MO1/MobileOpenGL/bin/shader/LightingMaps.vs","F:/github/MO1/MobileOpenGL/bin/shader/LightingMaps.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		materialsShader.use();
		materialsShader.setVec3("light.direction", -0.2f, -1.0f, -0.3f);
		materialsShader.setVec3("viewPos", camera.Position);

		//light
		materialsShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f);
		materialsShader.setVec3("light.diffuse", 0.5f, 0.5f, 0.5f);
		materialsShader.setVec3("light.specular", 1.0, 1.0, 1.0);
