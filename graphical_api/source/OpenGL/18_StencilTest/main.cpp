...
int main()
{
	...
	Shader shader("F:/github/MO1/MobileOpenGL/bin/shader/DepthTest.vs", "F:/github/MO1/MobileOpenGL/bin/shader/DepthTest.fs");
	...
	unsigned int cubeTexture = loadTexture("F:/github/MO1/MobileOpenGL/bin/asset/image/marble.jpg");
	unsigned int floorTexture = loadTexture("F:/github/MO1/MobileOpenGL/bin/asset/image/metal.png");
