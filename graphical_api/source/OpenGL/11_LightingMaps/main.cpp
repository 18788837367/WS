...
int main()
{
	...
	Shader lightCubeShader("F:/github/MO1/MobileOpenGL/bin/shader/LightCasters_LightCube.vs", "F:/github/MO1/MobileOpenGL/bin/shader/LightCasters_LightCube.fs");
	Shader materialsShader("F:/github/MO1/MobileOpenGL/bin/shader/LightCasters.vs","F:/github/MO1/MobileOpenGL/bin/shader/LightCasters.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//material
		materialsShader.setFloat("material.shininess", 64);
